...
const resolveRatingColor = (rating: number) => {
  ...
  else return "hsl(0 72.2% 50.6%)";
};

function MovieCard({ movie, item_type }: Props) {
  return (
    <div className="relative cursor-pointer rounded-2xl flex-shrink-0 transform hover:scale-100 transition duration-200 ease-out hover:drop-shadow-lg select-none">
        ...
        <div className="rounded-2xl overflow-hidden">
          <Image
            ...
            src={
              movie.backdrop_path != null
                ? getImagePath(movie.backdrop_path)
                : `/placeholder.svg`
            }
            width={1920}
            height={1080}
          ...
          {movie.vote_average !== 0 && movie.vote_average != undefined && (
            <div
              ...
              style={{ backgroundColor: resolveRatingColor(movie.vote_average) }}
            >
